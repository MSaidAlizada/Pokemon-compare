...
export const updatePokemon = (id, up, down) => axios.patch("http://localhost:5000/editPokemon", qs.stringify({pokemonId:id, upVotes:up, downVotes: down}), {headers: {'Content-Type': 'application/x-www-form-urlencoded'}});